/* Icon of the Seas — the reel.
   ...
   A cut sequence for a 9:16 vertical short, timed to a Hinglish voice-over.
   Each scene owns its camera move, its lighting, and its caption. Durations
   are the thing you retime once the voice track exists: change `dur` and
...
(function (global) {
  ...
  var SCENES = [
    ...
    {
      id: 'park', dur: 3.8, env: 'day', fov: 46,
